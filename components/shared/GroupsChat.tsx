...
// نظام محادثة الجروبات — مشترك بين لوحة الإدارة (/groups) وبوابة الطالب (تبويب "الجروبات")
// عشان نضمن إن كل الرسائل تتزامن بنفس الطريقة لكل المستخدمين، بدل وجود نسختين منفصلتين
