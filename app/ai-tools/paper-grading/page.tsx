...
اجعل "overallFeedback" ملاحظة شخصية فعلية تشير لنمط محدد بأداء الطالب (مثال: "أتقنت أسئلة الجمع تماماً، لكن راجع طريقة الاستلاف بالطرح" لا مجرد "أحسنت، واصل")، بأسلوب مشجّع لكن صادق.`;
}
